...
$_documentContainer$1.innerHTML = `<iron-iconset-svg name="icons" size="24">
<svg><defs>
...
function resolveURL(path, base) {
  if (workingURL$1 === undefined) {
    ...
    try {
      ...
      workingURL$1 = workingURL$1 && (new URL('http://www.google.com/?foo bar').href === 'http://www.google.com/?foo%20bar');
    } catch (e) {}
  }
  if (workingURL$1) {
...
const IronControlState = {
  ...
  properties: {
    ...
    __handleEventRetargeting: {
      type: Boolean,
      value: function() {
        return !this.shadowRoot && !Element$1;
      }
    }
  },
...
const $_documentContainer$2 = document.createElement('div');
...
const $_documentContainer$3 = document.createElement('div');
...
const $_documentContainer$4 = document.createElement('div');
$_documentContainer$4.setAttribute('style', 'display: none;');

$_documentContainer$4.innerHTML = `<dom-module id="paper-icon-button">
...
const $_documentContainer$5 = document.createElement('div');
...
const $_documentContainer$6 = document.createElement('div');
...
class RdHome extends Element$1 {
